...
HEADLESS_OPTIONS = ["--headless=new","--no-sandbox","--disable-gpu","--disable-setuid-sandbox","--window-size=1920,1080","--disable-setuid-sandbox","--disable-search-engine-choice-screen","--disable-blink-features=AutomationControlled"]
...
LLAMA_MODEL_FULLNAME="llama3.1:8b-text-fp16"

SYSTEM_MESSAGE = """You are an intelligent sentiment analysis assistant. 
Your task is to extract sentiments from individual articles. You only have to do this once for the whole future prompt.
These sentiments will be tied to a specific person from the given prompt. Everything will be in JSON format.
...
When processing the text:
	•	Consider only sentiments directly related to the person.
	•	Reflect the overall tone of the article toward the specific person.
	•	If the person is only sparsely mentioned, make a note in the JSON output.
	•	Make sure you give answers in proper English language.
The following aspects will be expected:
In the Article title field you will put the title of the website article you are reading. You will not make up names, you can state that the article name is not known.
In the Short LLM Description you will be writing 2-3 sentences about the reputation of the person in question.
In the Positive/Neutral/Negative fields you will be writing a score of 0-10 in each of them which will represent how Positive/Neutral/Negative an article is with regard to the reputation of the person in question.
In the Overall sentiment field, you will be averaging out all of the sentiments described before and boil them down to understand the reputation of the person.
Once the person is known, they will no longer change, everything will be tied to this person in your response.
Please process the following text and provide the output in pure JSON format with no words before or after the JSON."""

USER_MESSAGE = f"Extract the relevant information from the provided markdown. Ignore ads, images, and hyperlinks.\nPage content:\n\n"

PERSON_MESSAGE = f"The person you will revolve your response about is:\n"
