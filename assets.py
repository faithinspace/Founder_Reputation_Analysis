...
HEADLESS_OPTIONS = ["--headless=new","--no-sandbox","--disable-gpu","--window-size=1920,1080","--disable-setuid-sandbox","--disable-search-engine-choice-screen","--disable-blink-features=AutomationControlled"]
